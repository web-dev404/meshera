...
import { IPreviewTourItem, PreviewTourItem } from "@components/preview-tour-item/PreviewTourItem";

import styles from "./PreviewTour.module.scss";

interface IPreviewTour extends React.ComponentPropsWithoutRef<'section'> {
  title: string;
  description?: string;
...
const defaultProps: IPreviewTour = {
  title: "<span>Походная баня</span> – это специальная палатка, которая вмещает до 4 человек одновременно, и даже веником помахать остаётся место. Ну а про магию её сочетания с рекой и говорить нечего!",
