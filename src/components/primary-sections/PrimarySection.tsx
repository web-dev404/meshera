  ...
  return (
    <section className={clsx(styles.section, className)}>
      <div className={clsx(styles.section__container, "container")}>
        <div className={clsx(styles.section__header, { [styles.section__header_big]: !description })}>
          <h2 className={clsx(styles.section__title, "first-letter-fonts second-title")}>{htmlToReact(title)}</h2>
          {
            description ? 
